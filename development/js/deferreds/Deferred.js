define(function(require) {
	...
	var kindOf = require('amd-utils/lang/kindOf');
	...
	function createOptions( options ) {
		...
		forEach( options.split(/\s+/), function(flag) {
			object[ flag ] = true;
		});
		return object;
	}
					...
					if ( list ) {
						...
						(function add( args ) {
							forEach( args, function(arg) {
								var type = kindOf( arg ).toLowerCase();
								if ( type === "function" ) {
					...
					if ( list && ( !fired || stack ) ) {
						if ( firing ) {
							...
							try {
								...
								if (isFunction(this.then) && window.console && window.console.error) {
		...
		var tuples = [
			...
			promise = {
				...
				promise: function( obj ) {
					return obj !== undefined ? merge( obj, promise ) : promise;
				}
			},
			deferred = {};
